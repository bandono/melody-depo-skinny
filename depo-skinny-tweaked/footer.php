<br clear="all" />
    ...
    <div class="footer">
		...
		<div class="copyright">
            ...
            <?php endif; ?>
            <p>&copy; <?php bloginfo('name'); ?>. Powered by <a href="http://wordpress.org">WordPress</a> using the <a href="https://github.com/bandono/melody-depo-skinny">DePo Skinny Tweaked Theme</a>.</p>
            <?php wp_footer(); ?>
		</div>
